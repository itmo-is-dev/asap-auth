...
namespace Itmo.Dev.Asap.Auth.Identity.Services;
...
internal class AuthorizationService : IAuthorizationService
{
    ...
    public ClaimsPrincipal? DecodePrincipal(string token)
    {
        var validationParameters = new TokenValidationParameters
        {
            ...
            ValidAudiences = new[] { _configuration.Audience },
    ...
    public async Task<string> GetUserTokenAsync(string username, CancellationToken cancellationToken)
    {
        ...
        var token = new JwtSecurityToken(
            ...
            expires: DateTime.UtcNow.AddMinutes(_configuration.ExpiresMinutes),
            claims: claims,
